...
class CollectESBottomSheetTest {
    ...
    private lateinit var savedFeatureType: com.enbridge.gdsgpscollection.ui.map.models.FeatureType
    ...
    fun collectESBottomSheet_initialRendering_displaysHeader() {
        ...
        composeTestRule.setContent {
            com.enbridge.gdsgpscollection.ui.map.components.CollectESBottomSheet(
